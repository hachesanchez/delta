...
import { Card, CardImg, Row, Col, Container, Accordion } from 'react-bootstrap'
...
function WeWorkWith() {
    ...
    return (
        <div id="work-with-section" >
            <Container>

                <div className={`we-work-with ${visible ? 'visible' : ''}`}>
                ...
                <div className="work-with-section-mobile">
                    <Accordion>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header>
                                <div className='work-with-title-mobile'>
                                    Descubre con qué aseguradoras trabajamos
                                </div>
                            </Accordion.Header>
                            <Accordion.Body>
                                <Row className='g-0 work-with-row'>
